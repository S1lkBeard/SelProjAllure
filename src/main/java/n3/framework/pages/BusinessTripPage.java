...
public class BusinessTripPage extends BasePage {
    ...
    @Step("Проверка наличия и корректности заголовка")
    ...
    @Step("Выбор городов отбытия и прибытия")
    ...
    @Step("Выбор дат отбытия и прибытия")
    ...
    @Step("Клик по кнопке 'Сохранить и выйти'")
